...
export const day19Input1 = createReducer('', { 
    [types.DAY19_INPUT1](state, action) { 
        return action.input;
    }
});

export const day19Output1 = createReducer(undefined, { 
    [types.DAY19_OUTPUT1](state, action) { 
        return action.output;
    }
});

export const day19Output2 = createReducer(undefined, { 
    [types.DAY19_OUTPUT2](state, action) { 
        return action.output;
    }
});
...
export const day21Input1 = createReducer('', { 
    [types.DAY21_INPUT1](state, action) { 
        return action.input;
    }
});

export const day21Output1 = createReducer(undefined, { 
    [types.DAY21_OUTPUT1](state, action) { 
        return action.output;
    }
});

export const day21Output2 = createReducer(undefined, { 
    [types.DAY21_OUTPUT2](state, action) { 
        return action.output;
    }
});

export const day22Input1 = createReducer('', { 
    [types.DAY22_INPUT1](state, action) { 
        return action.input; 
    }
});

export const day22Output1 = createReducer(undefined, { 
    [types.DAY22_OUTPUT1](state, action) { 
        return action.output;
    }
});

export const day22Output2 = createReducer(undefined, { 
    [types.DAY22_OUTPUT2](state, action) { 
        return action.output;
    }
});

export const day23Input1 = createReducer('', { 
    [types.DAY23_INPUT1](state, action) { 
        return action.input;
    }
});

export const day23Output1 = createReducer(undefined, { 
    [types.DAY23_OUTPUT1](state, action) { 
        return action.output;
    }
});

export const day23Output2 = createReducer(undefined, { 
    [types.DAY23_OUTPUT2](state, action) { 
        return action.output;
    }
});

export const day24Input1 = createReducer('', { 
    [types.DAY24_INPUT1](state, action) { 
        return action.input;
    }
});

export const day24Output1 = createReducer(undefined, { 
    [types.DAY24_OUTPUT1](state, action) { 
        return action.output;
    }
});

export const day24Output2 = createReducer(undefined, { 
    [types.DAY24_OUTPUT2](state, action) { 
        return action.output;
    }
});