    ...
    render() { 
        return (
            <View>
                ...
                <Button onPress={Actions.day25} title='Day 25'/>
                <Button onPress={Actions.day24} title='Day 24'/>
                <Button onPress={Actions.day23} title='Day 23'/>
                <Button onPress={Actions.day22} title='Day 22'/>
